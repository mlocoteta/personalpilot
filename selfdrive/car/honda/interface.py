...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    torque_use_steering_angle = Params().get_bool("TorqueUseSteeringAngle")
    ...
    if Params().get_bool("CustomLateralTune"):
      ret.lateralTuning.init('torque')
      ret.lateralTuning.torque.useSteeringAngle = torque_use_steering_angle
      ret.lateralTuning.torque.kp = 2.0 / torque_max_lat_accel
      ret.lateralTuning.torque.kf = 1.0 / torque_max_lat_accel
      ret.lateralTuning.torque.ki = 0.5 / torque_max_lat_accel
      ret.lateralTuning.torque.friction = torque_friction
